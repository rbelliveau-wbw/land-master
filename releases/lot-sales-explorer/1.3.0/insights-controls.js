(function () {
  ...
  function mountSelect(control) {
    ...
    function open() {
      ...
      panel.innerHTML = '<div class="picker-search-row">'+searchIcon+'<input type="search" class="picker-search" aria-label="Search '+esc(label)+'" placeholder="Search '+esc(label.toLowerCase())+'…" autocomplete="off"></div>'+
