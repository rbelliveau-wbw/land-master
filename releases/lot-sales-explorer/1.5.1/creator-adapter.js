(function (root) {
  ...
  const fields = { lots: required.lots.concat(['Lot_Code','Block','Lot_Number','Archived','Interest1','Escalator','Notes']), subdivisions: required.subdivisions, projects: required.projects, builders: required.builders };
