(function(root){
  ...
  function mount(el,api){
    ...
    function render(){
      var list=el.querySelector('.pc-messages'),all=currentRows(),html='',day='',previous=null;
    ...
    return {open:function(pf){keepDraft();active=String(pf);editing='';preview=false;rows=[];composer();return refresh();},destroy:function(){clearInterval(timer);}};
  }
