...
assert.match(commentCss,/\.comment-activity-btn\{[^}]*transition:background \.18s ease,border-color \.18s ease,box-shadow \.18s ease,color \.18s ease/,'activity controls avoid hover translation and animate smoothly');
