...
assert.match(workflow,/input\.Contract == null/,'Comment Log validation accepts Contract-parent discussions');
assert.match(workflow,/input\.Contract = existingComment\.Contract/,'Comment Log edits preserve their Contract parent');
...
assert.match(contractSource,/parentField:'Contract'/,'contract rows use Contract discussions');
