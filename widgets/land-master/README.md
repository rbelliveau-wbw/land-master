...
Subdivision editors support adding, editing, and removing External System Mapping subform rows. The mapping editor exposes every data field on the subform: Subdivision, External System, and External Code.
